...
<body class="easyui-layout">
    <div data-options="region:'north',split:true" style="height:80px; background:url(__PUBLIC__/images/adminimage/topbg.jpg) #abcdef no-repeat center">
        <img src="__PUBLIC__/images/admin/logo.gif" height="65" style=" margin-left:30px; margin-top:10px" />
